...
├── ti_convergence_report.csv   # 每点 18 列诊断（sem_final, passed, failure_reasons, ...）
...
- **N_eff < 50 / Geweke 不平稳**：采样不够 / 前期没平衡。先试 `auto_equilibration=True`，自动二分砍前半。
