"""Tests for md_analysis.utils.formats.cp2k_cell."""

from __future__ import annotations

import pytest

from md_analysis.utils.formats.cp2k_cell import CellParseError, parse_abc_from_md_inp, parse_abc_from_restart
