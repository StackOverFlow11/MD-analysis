...
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vasp_gam > stdout 2>&1
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vaspsol_std > stdout 2>&1
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vaspsol_gam > stdout 2>&1
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vasp_std_vtst > stdout 2>&1
#mpiexec.hydra  -machinefile $PBS_NODEFILE -n $NP vasp_gam_vtst > stdout 2>&1
