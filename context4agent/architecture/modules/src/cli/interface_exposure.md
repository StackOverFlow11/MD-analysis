...
- `_enhanced_sampling.py` -- enhanced sampling sub-menu (codes 501-502) + slow-growth plot commands (lazy import of `enhanced_sampling.slowgrowth`)
...
- Leaf codes use numbered codes: 1xx=Water, 2xx=Potential, 3xx=Charge, 4xx=Scripts, 5xx=Enhanced Sampling, 9xx=Settings
